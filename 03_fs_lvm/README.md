...
└─sda3                            8:3    0   39G  0 part 
  ├─VolGroup00-LogVol00         253:0    0    8G  0 lvm  /
  ├─VolGroup00-LogVol01         253:1    0  1.5G  0 lvm  [SWAP]
  ├─VolGroup00-LogVol_Home-real 253:9    0    2G  0 lvm  
  │ ├─VolGroup00-LogVol_Home    253:8    0    2G  0 lvm  /home
  │ └─VolGroup00-home_snap      253:11   0    2G  0 lvm  
  └─VolGroup00-home_snap-cow    253:10   0  128M  0 lvm  
    └─VolGroup00-home_snap      253:11   0    2G  0 lvm  
sdb                               8:16   0   10G  0 disk 
└─vg_root-lv_root               253:5    0   10G  0 lvm  
sdc                               8:32   0    2G  0 disk 
...
Создадим раздел на все пространство диска /dev/sde :
...
Уменьшим размер файловой системы до 600 М и затем удалим раздел и создадим раздел с меньшим размером:

```
umount /data2
e2fsck -fy /dev/sde1
resize2fs /dev/sde1 600M
fdisk /dev/sde
d
n
p
